...
_translations: dict[str, dict[str, str]] = {
    ...
    "land_btn_load_density": {"zh": "加载密度图", "en": "Load Density Map"},
    "land_btn_load_density_tip": {"zh": "加载灰度图片控制省份密度（白=密集，黑=稀疏）", "en": "Load a grayscale image to control province density (white=dense, black=sparse)"},
    "land_btn_clear_density": {"zh": "清除", "en": "Clear"},
    "land_density_none": {"zh": "未加载密度图（均匀生成）", "en": "No density map (uniform generation)"},
