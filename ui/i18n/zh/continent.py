...
STRINGS: dict[str, str] = {
    "continent_remove_confirm_title": "删除大洲",
    "continent_remove_confirm_msg": "删除大洲「{name}」？属于该大洲的省份会变成无大洲。可撤销 (Ctrl+Z)。",
    "cont_dlg_add": "添加",
...
4. 再次点击按钮结束指派""",
    ...
    "continent_add_dlg_label": "大洲名 (英文):",
    "continent_add_dlg_title": "添加大洲",
    "continent_assign_by_state": "按州(State)批量分配",
    "continent_assign_section": "指派省份",
    "continent_delete_btn": "删除",
    "continent_list_section": "大陆列表",
    "continent_pick_btn": "开始指派省份",
    "continent_rename_btn": "重命名",
    "continent_rename_dlg_label": "新名字:",
    "continent_rename_dlg_title": "重命名",
    "continent_tip": "🌍 大洲 = HOI4 的 continent（北美 / 欧洲 / 非洲 ...），影响 wargoal 目标判定。\n所有陆地省份必须属于某个大洲（写入 continent.txt + definition.csv）。\n用法：先添加大洲 → 拾取模式点击省份分配。",
