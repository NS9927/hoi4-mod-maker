...
4. Нажмите снова для остановки""",
    ...
    "continent_tip": "Определите континенты и назначьте провинции. HOI4 требует, чтобы все сухопутные провинции принадлежали континенту, влияет на continent.txt и definition.csv. Сначала создайте континенты (напр. europe, asia), затем используйте режим выбора для назначения провинций выбранному континенту.",
